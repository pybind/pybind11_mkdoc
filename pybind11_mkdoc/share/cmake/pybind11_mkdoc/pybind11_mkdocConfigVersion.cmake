# This is a basic version file for the Config-mode of find_package(). It is used
# by write_basic_package_version_file() as input file for configure_file() to
# create a version-file which can be installed along a config.cmake file.
#
# The created file sets PACKAGE_VERSION_EXACT if the current version string and
# the requested version string are exactly the same and it sets
# PACKAGE_VERSION_COMPATIBLE if the current version is >= requested version, but
# only if the requested major version is the same as the current one. The
# variable CVF_VERSION must be set before calling configure_file().
    ...
    if(NOT PACKAGE_FIND_VERSION_MIN_MAJOR STREQUAL CVF_VERSION_MAJOR
       OR ((PACKAGE_FIND_VERSION_RANGE_MAX STREQUAL "INCLUDE"
           ...
           OR (PACKAGE_FIND_VERSION_RANGE_MAX STREQUAL "EXCLUDE"
               AND NOT PACKAGE_FIND_VERSION_MAX VERSION_LESS_EQUAL
                   CVF_VERSION_MAJOR_NEXT)
          ))
      set(PACKAGE_VERSION_COMPATIBLE FALSE)
    elseif(
